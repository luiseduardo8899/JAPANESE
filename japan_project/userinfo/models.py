...
class Profile(models.Model):  
    ...
    country = models.IntegerField(choices=COUNTRY_IDS, default=UNITED_STATES_ID) # Country of Birth : required
    gender = models.IntegerField(choices=GENDER_IDS, default=MALE_ID)
    gender_other = models.CharField(max_length=50, default="")
    year_ob = models.IntegerField(choices=YEAR_IDS) # Year born 
    month_ob = models.IntegerField(choices=MONTH_IDS) # Month born
    day_ob = models.IntegerField(choices=DAY_IDS) # Day born
    location = models.IntegerField(choices=COUNTRY_IDS, default=UNITED_STATES_ID) # Country of Birth : required
    language = models.IntegerField(choices=LANGUAGE_IDS, default=ENGLISH_ID) #Mother Tongue
